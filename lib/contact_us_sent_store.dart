...
class ContactUsSentStore extends StatelessWidget {
  @override
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                          margin: EdgeInsets.only(top:20.0),
                          child:Text('Your message has been sent to administration.',textAlign: TextAlign.center,style: TextStyle(fontSize: 16.0, color: Colors.grey[600],)),
                      ),
